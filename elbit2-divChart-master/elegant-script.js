...
document.addEventListener("activate",drawChart);
drawChart();
document.getElementById("bar").addEventListener("click",drawChart);
document.getElementById("line").addEventListener("click",drawChart);
document.getElementById("pie").addEventListener("click",drawChart);
